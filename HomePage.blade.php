...
<a class="text-sm font-semibold text-[#111813]/70 hover:text-primary transition-colors" href="#">Home</a>
...
<button class="flex items-center gap-2 bg-primary text-[#111813] px-6 py-2.5 rounded-full text-sm font-bold hover:shadow-lg hover:shadow-primary/20 transition-all">
<span class="material-symbols-outlined text-sm">dashboard</span>
                Dashboard
            </button>
</nav>
<button class="md:hidden text-[#111813]">
...
<button class="bg-primary text-[#111813] px-8 py-4 rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-primary/20 transition-all">
                        Explore Dashboard
                    </button>
<button class="bg-white dark:bg-[#1a2e20] border border-[#dbe6df] dark:border-[#2a3d31] px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#f0f4f2] transition-all">
                        View Hardware Spec
                    </button>
</div>
</div>
